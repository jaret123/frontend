...
UPDATE xeros_cycle as a set a.olson_timezone_id = (select olson_timezone_id from xeros_dai_meter_collection as c where c.dai_meter_actual_id = a.dai_meter_actual_id);