...
//            }
        ...
        var labels = {
            'non-xeros' : {
                lineA : Drupal.t('Actual Cost'),
                lineB : Drupal.t('Potential Cost'),
                'lineA-key' :  Drupal.t('Current Consumption'),
            ...
            xeros : {
                ...
                'lineA-key' :  Drupal.t('Current Consumption'),
                'lineB-key' :  Drupal.t('Industry Benchmark'),
