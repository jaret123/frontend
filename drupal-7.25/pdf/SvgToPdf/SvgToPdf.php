...
ini_set('include_path','/Applications/MAMP/bin/php/php5.5.3/lib/php');

require_once 'Morph.php';
require_once '../tfpdf/tfpdf.php';
require_once 'SvgToPdf/Base.php';
require_once 'SvgToPdf/G.php';
require_once 'SvgToPdf/Rect.php';
require_once 'SvgToPdf/Text.php';
require_once 'SvgToPdf/Tspan.php';
require_once 'SvgToPdf/Path.php';
